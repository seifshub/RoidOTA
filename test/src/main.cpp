...
// // // ----------- USER LOGIC -----------
// // void userSetup() {
// //   Serial.println("userSetup(): Initializing pin...");
...
// //     digitalWrite(2, !digitalRead(2));  // Toggle LED every 1 sec
// //     lastToggle = millis();
// //   } 
// // }
...
// // void setup() {
// //   Serial.begin(115200);
// //   RoidOTA::begin(DEVICE_ID, userSetup, userLoop);
// // }

// // void loop() {
// //   RoidOTA::handle(); // Handles MQTT, OTA, heartbeat...
// // }
#include <Arduino.h>
#include <RoidOTA.h>
