    ...
    export class FirmwareController {
        ...
        async uploadBin(
            ...
            return this.firmwareService.uploadBin(file, firmwareName);
        }
        ...
        @ApiOperation({ summary: 'test a specific device' })
        async testDevice(@Param('deviceId') deviceId: string, @Body('mess') mess: string,) {
            return this.firmwareService.sendTest(deviceId, mess);
        }
